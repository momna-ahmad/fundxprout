...
import { TrendingUp, Users, DollarSign, Target, Plus, Eye, Edit, BarChart3 } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage your campaigns and track your progress</p>
          </div>
          <Link
                    ...
                    <div key={campaign.id} className="border border-gray-200 rounded-lg p-6">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-[#f6851b]">${campaign.raised.toLocaleString()}</p>
                        </div>
                        <div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-gray-200">
                        ...
                        <th className="text-left py-3 px-4 font-medium text-gray-700">Backers</th>
                    ...
                    <tbody>
                      {campaigns.map((campaign) => (
                        <tr key={campaign.id} className="border-b border-gray-100">
                          ...
                          <td className="py-4 px-4">${campaign.goal.toLocaleString()}</td>
                          <td className="py-4 px-4 text-[#f6851b] font-medium">${campaign.raised.toLocaleString()}</td>
                          ...
                          <td className="py-4 px-4">
                            <div className="flex gap-2">
                              <button className="text-[#6f42c1] hover:text-[#5a3599] font-medium text-sm">View</button>
                              <button className="text-gray-600 hover:text-gray-800 font-medium text-sm">Edit</button>
                            </div>
                          </td>
                        </tr>
                      ))}
                    ...
                    <div className="space-y-3">
                      {campaigns.slice(0, 3).map((campaign, index) => (
                        <div key={campaign.id} className="flex items-center justify-between">
                          ...
                          <span className="text-sm text-[#f6851b] font-medium">${campaign.raised.toLocaleString()}</span>
                        </div>
                      ))}
                    </div>
                  </div>
